<!-- /resources/views/collections/bookmarks.blade.php -->
@extends('layouts.app')

@section('content')

	<h3>Change views</h3>
	<h4>Which models do you want to show on the home screen?</h4>
	...
	@if ( $collections->count() )
		...
		<th style="text-align: center;"><h4>View</h4></th>
		</tr>
	...
	<button type="submit" class="btn btn-primary">Update view(s)</button>
